...
public class FirstTestClass extends BaseTest {
    ...
    public void checkThatTheDataIsTheSame() {
        ...
        softAssertions.assertThat(actualResultName)
        ...
        softAssertions.assertThat(actualResultEmail)
        ...
        softAssertions.assertThat(actualResultCurrentAddress)
        ...
        softAssertions.assertThat(actualResultPermananetAddress)
